...
MultipartParser mp =new MultipartParser(request, 999999999);
		...
		String fullpath=editpath+"Mechanic\\WebContent\\Locals\\";
	...
	//file encrypted and store into filepath1
             ...
             filepath1 = editpath + "\\Mechanic\\WebContent\\Encrypt\\"+filename;
              ...
              //file decrypted and store into filepath2
        		    ...
        		    filepath2 = editpath + "\\Mechanic\\WebContent\\Decrypt\\"+filename;
     ...
     filepath1 = editpath + "\\Mechanic\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
			...
			tlfilebean up=new tlfilebean();
			 ...
			 up.setTeam(paramValues.get(0).toString());
	            System.out.println("Category: "+paramValues.get(0));
	            
		
			  up.setName(paramValues.get(2).toString());
            System.out.println("Category: "+paramValues.get(0));
            
            
          up.setMobile(paramValues.get(4).toString());
          System.out.println("des: "+paramValues.get(2));
          
          up.setMail(paramValues.get(6).toString());
          System.out.println("tlmail: "+paramValues.get(4));
          
          
        up.setDob(paramValues.get(8).toString());
        System.out.println("des: "+paramValues.get(6));
        
        up.setLocation(paramValues.get(10).toString());
        System.out.println("des: "+paramValues.get(8));
        
        up.setAathor(paramValues.get(12).toString());
        System.out.println("des: "+paramValues.get(10));
        
        up.setAge(paramValues.get(14).toString());
        System.out.println("des: "+paramValues.get(12));
        
        up.setAddress(paramValues.get(16).toString());
        System.out.println("des: "+paramValues.get(14));
        
        up.setLicense("yes");
        System.out.println("liscence yes: ");
        
        up.setmap(paramValues.get(18).toString());
